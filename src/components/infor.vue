<template>
  <div id="infor">
    <div class="inforHeader">
      <div style="font-size:17px;" class="ib">平台总体概览
        <Icon type="md-timer" style="color:blue"/>
    ...
    <div class="inforContent">
      <div class="inforContentLeft">
        <div class="inforContentLeft1 shadow">
          <div class="border-right ib"><InforIcon :data="datahead[0]"></InforIcon></div>
          <div class="border-right ib"><InforIcon :data="datahead[1]"></InforIcon></div>
          <div class="border-right ib"><InforIcon :data="datahead[2]"></InforIcon></div>
          <div class=" ib"><InforIcon :data="datahead[3]"></InforIcon></div>
        </div>
      ...
      <div class="inforContentRight">
        <div class="inforContentRight1">
          <div class="mb15 shadow"><InforIcon :data="datahead[4]"></InforIcon></div>
          <div class=" shadow"><InforIcon :data="datahead[5]"></InforIcon></div>
        </div>
        <div class="inforContentRight2">
          <CircleL :percent="percent" :title="titleCircleL"></CircleL>
        </div>
