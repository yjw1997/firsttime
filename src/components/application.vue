<template>
  <div id="table">
    ...
    <AppliEdit :SelectData="SelectData" :loading="loading" :modal1="modal1" :editdata="editdata"></AppliEdit>
    <AppliView :SelectData="SelectData" :loading="loading" :modal2="modal2" :viewdata="viewdata"></AppliView>
  </div>
</template>
<script>
